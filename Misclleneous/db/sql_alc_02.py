...
if __name__ == "__main__":
    # db = DataBase(
    #     "postgresql", "postgres", "postgres", "192.168.56.101", "5432", "otaf"
    # )
    # print("Create db object")
    # db = DataBase(
    #     "postgresql", "postgres", "postgres", "192.168.56.114", "5432", "otaf_git11"
    # )
    ...
    print("Create db object")
    db = DataBase(
        "postgresql", "postgres", "postgres", "192.168.56.114", "5432", "es_db"
    )

    metrics_df = db.read_table(table_name="metrics")
    print(metrics_df)

    df_production = db.read_table(table_name="t_oil")
    print(df_production)
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("production_vs_consumption.png")

    plt.show()

    # oil_df = db.read_table(table_name="t_oil")
    # print(oil_df)
